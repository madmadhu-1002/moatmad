                ...
                <Row className={`mt-5 ${styles.sellComponentRow} mb-5`}>
                    <Col lg={4}>
                        <div className='d-flex align-items-center gap-2'>
                            <img src='https://cdn-icons-png.freepik.com/256/7064/7064309.png?ga=GA1.1.769605160.1678772043&semt=ais_hybrid' alt="Step 1" />
                            <span>Get your Free Car Evaluation</span>
                        </div>
                    </Col>
                    <Col lg={4}>
                        <div className='d-flex align-items-center gap-2'>
                            <img src='/assets/product-feture-icons/226300.png' alt="Step 2" />
                            <span>Book Appointment for Car Inspection</span>
                        </div>
                    </Col>
                    <Col lg={4}>
                        <div className='d-flex align-items-center gap-2'>
                            <img src="/assets/product-feture-icons/3734403.png" alt="Step 3" />
