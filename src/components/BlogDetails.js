        ...
        <>
            <Container fluid className="blog-details-container">
                <Row className="mt-5 mb-5">
                            ...
                            {remainingBlogContent && remainingBlogContent.map((post, index) => (
                                <div key={index} className="latest-news-item mb-4">
                                    <Link href={`/blog/${post.slug}`} className="latest-news-link text-decoration-none text-black">
                                        <Image src={post.medium_image} alt={post.title || 'post title'} className="latest-news-image" width={444} height={333}/>
                    ...
                    <Col md={9} className={styles.insideBlogCol8}>
                        {blogscontent &&
                            <div className="blog-content">
                                <Image alt={blogscontent} src={blogscontent.image} className='blog-image mb-4' width={870} height={307}/>
